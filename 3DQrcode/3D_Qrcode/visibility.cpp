...
bool qrcode::visibility(Engine * engine, Eigen::MatrixXd & V_pxl, Eigen::MatrixXf & Src, Eigen::MatrixXf & Dir, Eigen::MatrixXd & th, Eigen::MatrixXd & th_crv, Eigen::MatrixXd & BW, std::vector<Eigen::MatrixXi>& B_qr, std::vector<Eigen::MatrixXd>& B_md, Eigen::MatrixXd & V_fin, Eigen::MatrixXd & vis)
{
	return false;
}
