...
#include <string>
namespace qrcode {
	bool optimization(Engine *engine, Eigen::MatrixXd&D, Eigen::MatrixXd &Func,Eigen::Matrix4f &mode, int wht_num, int mul,int ext, Eigen::MatrixXd &V_uncrv, Eigen::MatrixXi &F_qr, Eigen::MatrixXd &C_qr, Eigen::MatrixXi &E_qr,
